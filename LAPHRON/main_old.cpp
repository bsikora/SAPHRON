...
int main(int narg, char **arg)
{
  ...
  double rcut = 300.0;
  World world(1000.0, 1000.0, 1000.0, rcut, seed); // same as lammps input data file
  world.SetTemperature(1.0);
  WorldManager WM;
  WM.AddWorld(&world);
  MoveManager MM (seed+1);
  ...
  AcidTitrationMove AcidTitMv({{"Monomer"}}, 1.67, atof(arg[6]), seed+3);  // proton charge, mu

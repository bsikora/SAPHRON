...
namespace SAPHRON
{
	...
	public:
		...
		static std::string MODDeleteParticleMove;
		static std::string MODInsertParticleMove;
		static std::string MDMoveMultiCore;
		static std::string MDMoveSSages;
